...
export const blogPosts: BlogPost[] = [
  {
    id: 'how-to-choose-a-general-contractor',
    title: 'How to Choose a General Contractor (Complete Guide 2026)',
    slug: 'how-to-choose-a-general-contractor',
    date: '2026-03-23',
    author: 'BNC Builders Inc.',
    category: 'Home Remodeling',
    categorySlug: 'home-remodeling',
    excerpt: 'Learn how to choose a general contractor with our complete guide. 15 questions to ask, red flags to avoid, and a free checklist.',
    content: [
    ...
    featuredImage: 'v1774259397/BNC_Blog_Feb_How_To_Choose_General_Contractor_wtaphp.webp',
    readTime: 15,
  },
  {
