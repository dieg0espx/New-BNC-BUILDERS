  ...
  return (
    <>
      ...
      <HeroSubpage
        ...
        subtitle="Our best projects come from referrals. When you send friends, family, or neighbors our way, we say thank you with rewards you will actually appreciate."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-zinc-600 mb-6">
                You trusted BNC Builders with your remodeling project. Now share that experience. When someone you refer completes a project with us, we send you a gift card to your favorite restaurant - our way of thanking you for spreading the word.
              </p>
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-zinc-700">Reward sent after your referral completes their project</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-gold flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-700">No limit on referrals - the more you share, the more you earn</span>
                </li>
              </ul>
            </div>
            <div>
