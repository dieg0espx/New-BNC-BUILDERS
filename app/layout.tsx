  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Twitter/X Card Tags */}
        <meta name="twitter:image" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.bncbuildersinc.com'}/opengraph-image`} />
        <meta name="twitter:image:alt" content="BNC Builders - Home Remodeling" />
        {/* WhatsApp and Messaging Apps */}
        <link rel="image_src" href={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.bncbuildersinc.com'}/opengraph-image`} />
        <meta itemProp="image" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.bncbuildersinc.com'}/opengraph-image`} />
